...
@section('content')
    <div class="card">
        <a href="{{ route('admin.productores.create') }}" title="Crear Nuevo Productor"
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <form method="post"
                                                action="{{ route('admin.productores.destroy', $productor->id) }}">
                                                @method('delete')
                                                @csrf
                                        ...
                                        <div class="col-md-4 form-group">
                                            <form method="get"
                                                action="{{ route('admin.productores.edit', $productor->id) }}">
